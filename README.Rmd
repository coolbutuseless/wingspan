...
Thanks to [hbgoldspiel](https://twitter.com/hbgoldspiel) on twitter for this
great dendogram grouping birds by their similarity.
...
# Plot
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
png("man/figures/phylo.png", width = 3000, height = 3000)
plot(ape::as.phylo(birds_ch_ward), type = "fan", cex = 1)
dev.off()

cairo_pdf("man/figures/phylo.pdf", width = 30, height = 30)
plot(ape::as.phylo(birds_ch_ward), type = "fan", cex = 1)
dev.off()
```
